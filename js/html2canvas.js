...
// but would require further work to calculate the correct positions for elements with offsetParents
    ...
    _html2canvas.Parse = function ( images, options, cb )
    {
        ...
        function setTextVariables( ctx, el, text_decoration, color )
        {
            ...
            ctx.setVariable( "font", [getCSS( el, "fontStyle" ), getCSS( el, "fontVariant" ), bold, size, family
            ].join( " " ) );
        ...
        function bezierCurve( start, startControl, endControl, end )
        {
            ...
            return {
                ...
                {
                    borderArgs.push( ["bezierCurve", startControl.x, startControl.y, endControl.x, endControl.y, end.x,
                                      end.y] );
                },
                curveToReversed: function ( borderArgs )
                {
                    borderArgs.push( ["bezierCurve", endControl.x, endControl.y, startControl.x, startControl.y,
                                      start.x, start.y] );
                }
            };
        }
